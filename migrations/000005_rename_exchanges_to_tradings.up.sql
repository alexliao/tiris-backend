-- Migration: Rename exchanges to tradings
...
-- Step 8: Create new unique indexes for tradings table
...
-- Step 13: Update the balance update function to use new table and column names
...
-- Add notification about successful migration
DO $$
BEGIN
